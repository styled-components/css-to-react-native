...
it('transforms flex shorthand with 3 values', function () {
  expect((0, _2.default)([['flex', '1 2 3px']])).toEqual({
    flexGrow: 1,
    flexShrink: 2,
    flexBasis: 3
  });
...
it('transforms flex shorthand with 3 values in reverse order', function () {
  expect((0, _2.default)([['flex', '3px 1 2']])).toEqual({
    flexGrow: 1,
    flexShrink: 2,
    flexBasis: 3
  });
...
it('transforms flex shorthand with 2 values of flex-grow and flex-shrink', function () {
  expect((0, _2.default)([['flex', '1 2']])).toEqual({
    flexGrow: 1,
    flexShrink: 2,
    flexBasis: 0
  });
...
it('transforms flex shorthand with 2 values of flex-grow and flex-basis', function () {
  expect((0, _2.default)([['flex', '2 2px']])).toEqual({
    flexGrow: 2,
    flexShrink: 1,
    flexBasis: 2
  });
...
it('transforms flex shorthand with 2 values of flex-grow and flex-basis (reversed)', function () {
  expect((0, _2.default)([['flex', '2px 2']])).toEqual({
    flexGrow: 2,
    flexShrink: 1,
    flexBasis: 2
  });
...
it('transforms flex shorthand with 1 value of flex-grow', function () {
  expect((0, _2.default)([['flex', '2']])).toEqual({
    flexGrow: 2,
    flexShrink: 1,
    flexBasis: 0
  });
...
it('transforms flex shorthand with 1 value of flex-basis', function () {
  expect((0, _2.default)([['flex', '10px']])).toEqual({
    flexGrow: 1,
    flexShrink: 1,
    flexBasis: 10
  });
...
it('transforms flex shorthand with flex-grow/shrink taking priority over basis', function () {
  expect((0, _2.default)([['flex', '0 1 0']])).toEqual({
    flexGrow: 0,
    flexShrink: 1,
    flexBasis: 0
  });
...
it('transforms flex shorthand with flex-basis set to auto', function () {
  expect((0, _2.default)([['flex', '0 1 auto']])).toEqual({
    flexGrow: 0,
    flexShrink: 1
  });
});
...
it('transforms flex shorthand with flex-basis set to auto appearing first', function () {
  expect((0, _2.default)([['flex', 'auto 0 1']])).toEqual({
    flexGrow: 0,
    flexShrink: 1
  });
});
...
it('transforms flex auto keyword', function () {
  expect((0, _2.default)([['flex', 'auto']])).toEqual({
    flexGrow: 1,
    flexShrink: 1
  });
});
...
it('transforms flex none keyword', function () {
  expect((0, _2.default)([['flex', 'none']])).toEqual({
    flexGrow: 0,
    flexShrink: 0
  });
});
...
it('does not transform invalid flex', function () {
  expect(function () {
    return (0, _2.default)([['flex', '1 2px 3']]);
  }).toThrow();
});